/*****************************************************************//**
 * \file   5G_NR.h
 * \brief  rate profiling based on 5G_NR
 * 
 * \author YZJ
 * \date   April 2024
 *********************************************************************/
...
static void NR_5G(int* A_list, int* frozen_position, int* data_position);
...
static void NR_5G(int* A_list, int* frozen_position, int* data_position)
{
	...
	if (pos == N) {
		...
		int real_pos_rev[N] = { 0 };
		reverse_copy(real_pos, real_pos + N, real_pos_rev);

		//获得 信息位位置和冻结位位置
		for (size_t i = 0; i < N - K; i++)
		{
			frozen_position[i] = real_pos[i];
		}
		for (size_t i = 0; i < K; i++)
		{
			data_position[i] = real_pos_rev[i];
		}

		memset(A_list, 0, sizeof(A_list));
		for (size_t i = 0; i < K; i++)
		{
			A_list[data_position[i]] = 1;
		}
